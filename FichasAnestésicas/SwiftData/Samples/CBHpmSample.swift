...
extension CbhpmProcedure {
    static var sampleCbhpmProcedures: [CbhpmProcedure] {
        let surgeries = Surgery.sampleSurgeries
        return [
            CbhpmProcedure(
                surgery: surgeries[0],
                code: "3.09.12.18-0",
...
extension Financial {
    static var sampleFinancials: [Financial] {
        let surgeries = Surgery.sampleSurgeries
        return [
            Financial(
                surgery: surgeries[1],
...
extension SharedPreAndAnesthesia {
    static var sampleSharedPreAndAnesthesia: [SharedPreAndAnesthesia] {
        let surgeries = Surgery.sampleSurgeries
        return [
    ...
    static func configureSampleRelationships() {
        Surgery.sampleSurgeries[0].shared = sampleSharedPreAndAnesthesia[0]
        Surgery.sampleSurgeries[1].shared = sampleSharedPreAndAnesthesia[1]
        Surgery.sampleSurgeries[2].shared = sampleSharedPreAndAnesthesia[2]
        Surgery.sampleSurgeries[3].shared = sampleSharedPreAndAnesthesia[3]
        Surgery.sampleSurgeries[4].shared = sampleSharedPreAndAnesthesia[4]
        Surgery.sampleSurgeries[5].shared = sampleSharedPreAndAnesthesia[5]
        Surgery.sampleSurgeries[6].shared = sampleSharedPreAndAnesthesia[6]
        Surgery.sampleSurgeries[7].shared = sampleSharedPreAndAnesthesia[7]
        Surgery.sampleSurgeries[8].shared = sampleSharedPreAndAnesthesia[8]
        Surgery.sampleSurgeries[9].shared = sampleSharedPreAndAnesthesia[9]
        Surgery.sampleSurgeries[10].shared = sampleSharedPreAndAnesthesia[10]
        Surgery.sampleSurgeries[11].shared = sampleSharedPreAndAnesthesia[11]
        Surgery.sampleSurgeries[12].shared = sampleSharedPreAndAnesthesia[12]
        Surgery.sampleSurgeries[13].shared = sampleSharedPreAndAnesthesia[13]
        Surgery.sampleSurgeries[14].shared = sampleSharedPreAndAnesthesia[14]
        Surgery.sampleSurgeries[15].shared = sampleSharedPreAndAnesthesia[15]
        Surgery.sampleSurgeries[16].shared = sampleSharedPreAndAnesthesia[16]
        Surgery.sampleSurgeries[17].shared = sampleSharedPreAndAnesthesia[17]
        Surgery.sampleSurgeries[18].shared = sampleSharedPreAndAnesthesia[18]
        Surgery.sampleSurgeries[19].shared = sampleSharedPreAndAnesthesia[19]
        Surgery.sampleSurgeries[20].shared = sampleSharedPreAndAnesthesia[20]
        Surgery.sampleSurgeries[21].shared = sampleSharedPreAndAnesthesia[21]
        Surgery.sampleSurgeries[22].shared = sampleSharedPreAndAnesthesia[22]
        Surgery.sampleSurgeries[23].shared = sampleSharedPreAndAnesthesia[23]
        Surgery.sampleSurgeries[24].shared = sampleSharedPreAndAnesthesia[24]
        Surgery.sampleSurgeries[25].shared = sampleSharedPreAndAnesthesia[25]
        Surgery.sampleSurgeries[26].shared = sampleSharedPreAndAnesthesia[26]
        Surgery.sampleSurgeries[27].shared = sampleSharedPreAndAnesthesia[27]
        Surgery.sampleSurgeries[28].shared = sampleSharedPreAndAnesthesia[28]
        Surgery.sampleSurgeries[29].shared = sampleSharedPreAndAnesthesia[29]
        Surgery.sampleSurgeries[30].shared = sampleSharedPreAndAnesthesia[30]
        Surgery.sampleSurgeries[31].shared = sampleSharedPreAndAnesthesia[31]
        Surgery.sampleSurgeries[32].shared = sampleSharedPreAndAnesthesia[32]
        Surgery.sampleSurgeries[33].shared = sampleSharedPreAndAnesthesia[33]
        Surgery.sampleSurgeries[34].shared = sampleSharedPreAndAnesthesia[34]
        Surgery.sampleSurgeries[35].shared = sampleSharedPreAndAnesthesia[35]
        Surgery.sampleSurgeries[36].shared = sampleSharedPreAndAnesthesia[36]
        Surgery.sampleSurgeries[37].shared = sampleSharedPreAndAnesthesia[37]
        Surgery.sampleSurgeries[38].shared = sampleSharedPreAndAnesthesia[38]
        Surgery.sampleSurgeries[39].shared = sampleSharedPreAndAnesthesia[39]
        Surgery.sampleSurgeries[40].shared = sampleSharedPreAndAnesthesia[40]
        Surgery.sampleSurgeries[47].shared = sampleSharedPreAndAnesthesia[41]
        Surgery.sampleSurgeries[61].shared = sampleSharedPreAndAnesthesia[42]
        Surgery.sampleSurgeries[71].shared = sampleSharedPreAndAnesthesia[43]
        Surgery.sampleSurgeries[74].shared = sampleSharedPreAndAnesthesia[44]
        Surgery.sampleSurgeries[78].shared = sampleSharedPreAndAnesthesia[45]
        Surgery.sampleSurgeries[79].shared = sampleSharedPreAndAnesthesia[46]
        Surgery.sampleSurgeries[80].shared = sampleSharedPreAndAnesthesia[47]
        Surgery.sampleSurgeries[84].shared = sampleSharedPreAndAnesthesia[48]
        Surgery.sampleSurgeries[85].shared = sampleSharedPreAndAnesthesia[49]
        Surgery.sampleSurgeries[86].shared = sampleSharedPreAndAnesthesia[50]
        Surgery.sampleSurgeries[91].shared = sampleSharedPreAndAnesthesia[51]
    }
}
