...
struct SRPAVitalSignsFormView: View {
    @ObservedObject var viewModel: SRPAVitalSignsFormViewModel
    ...
    var body: some View {
        Form {
            if viewModel.isNew && viewModel.srpaEnd == nil {
...
//                            .foregroundStyle(.secondary)
        ...
        .toolbar {
            ...
            if viewModel.isNew && viewModel.srpaEnd != nil || viewModel.isNew && seriesDurationMinutes != nil {
                ToolbarItem(placement: .topBarTrailing){
                    Button {
                        do {
                            //viewModel.healthyPatient()
